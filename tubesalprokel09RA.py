...
def volunteerverse_dashboard():
    st.title("Dashboard")
    st.image("/Users/dananghilalkurniawan/Downloads/VolunteerVerse!Banner.jpeg", use_column_width=True)
...
def volunteerverse_program():
    ...
    volunteer_list = [
        ...
        },
        {
            ...
            "gambar": "/Users/dananghilalkurniawan/Downloads/gambar4.jpeg",
    ...
    sub_bab_list = [
        {
            ...
            "image_path": "/Users/dananghilalkurniawan/Downloads/qrvol.jpeg"
        },
        {
